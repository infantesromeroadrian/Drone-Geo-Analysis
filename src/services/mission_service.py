...
class MissionService:
    ...
    def create_llm_mission(self, natural_command: str, area_name: str = None) -> Dict[str, Any]:
    ...
    def get_loaded_areas(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self.mission_planner, 'loaded_areas'):
                for area_name, area_data in self.mission_planner.loaded_areas.items():
                    areas.append({
                        'name': area_name,
